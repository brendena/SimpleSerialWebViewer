...
export async function serial_writeCommand(writer, text) {
    await writer.write(text)
    await writer.write('\r')
}

export async function serial_readResponse(reader) {
    let response = '';
...
export async function serial_readWrite(reader, writer, command) {
...
export async function serial_close() {
...
export async function serial_connectPort(port, baudRate) {
